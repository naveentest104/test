...
const problems: Problem[] = [
  {
    ...
    sampleInputs: [{ input: "greet()", output: "Hello, World!" }],
  },
  {
    id: 2,
    title: "Two Sum",
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="mb-6 flex flex-wrap gap-4">
        ...
        <Select value={difficultyFilter} onValueChange={(value: string) => setDifficultyFilter(value as "Easy" | "Medium" | "Hard" | "All")}>
          ...
          <Card key={problem.id} className="hover:shadow-xl transition-shadow duration-300 transform hover:scale-105">
            ...
            <CardContent>
              ...
              <Button
                ...
                className="w-full bg-gradient-to-r from-blue-500 to-purple-500 hover:from-purple-500 hover:to-blue-500 shadow-lg"
              >
